...
$lang ['admin'] ['plugin'] ['publisharticle'] = array(
	...
	'images_rejected_title' => 'Some images were not uploaded',
	'image_rejected'        => 'Image %d (%s) was not uploaded: %s',
	'image_rejected_limit'  => 'Image %d (%s) was not uploaded: %s (maximum upload size: %s)',
