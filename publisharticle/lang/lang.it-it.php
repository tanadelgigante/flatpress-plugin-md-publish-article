...
$lang ['admin'] ['plugin'] ['publisharticle'] = array(
	...
	'images_rejected_title' => 'Alcune immagini non sono state caricate',
	'image_rejected'        => 'Immagine %d (%s) non caricata: %s',
	'image_rejected_limit'  => 'Immagine %d (%s) non caricata: %s (dimensione massima di caricamento: %s)',
